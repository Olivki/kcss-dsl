...
class RenderTest : ATest {
    ...
    fun selectors_multiple() {
        ...
        testRender(
            "a,div,span{width:1}a:hover{width:1}a:hover a,a:hover div{width:1}div:hover{width:1}div:hover a,div:hover div{width:1}span:hover{width:1}span:hover a,span:hover div{width:1}"
        ) {
            a and div and span {
                width = 1
                hover {
        ...
        testRender(
            "a:hover{width:1}div:hover{width:1}span:hover{width:1}a>li{width:2}div>li{width:2}span>li{width:2}"
        ) {
            a and div and span {
                hover { width = 1 }
                child.li { width = 2 }
    ...
    fun selectors_attributes() {
        ...
        testRender(
            "input[disabled],textarea[disabled]{width:1}input[disabled][type=hidden],textarea[disabled][type=hidden]{width:1}"
        ) {
